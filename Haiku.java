...
public class Haiku extends JFrame implements ActionListener {
 ...
 // ============================ PRIMARY METHODS ================================ \\
	...
	private String buildSentence(int syllablesLeft, int startIndex) {
		...
		//-- if (word == null), no words can be found that meet the criteria, and you need a bigger dictionary.
		if(word != null) {
			...
			if((graph.reachedEnd() || syllablesLeft - Dictionary.syllableCount(word) < 1) 
